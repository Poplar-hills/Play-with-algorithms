...
public class Exercise_KthSmallestElement_HeapSelect {
    ...
    public static Comparable minHeapSelect(Comparable[] arr, int k) {
    ...
    public static Comparable maxHeapSelect(Comparable[] arr, int k) {
        PriorityQueue<Comparable> pq = new PriorityQueue<>(k + 1, Collections.reverseOrder());  // 给 PriorityQueue 配置 comparator 用作最大堆
